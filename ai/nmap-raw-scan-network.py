...
def run_nmap_scan(host_ip, scanned_macs, output_folder):
    ...
    nmap_command = [
        ...
        "--script=rdp-ntlm-info,snmp-info,http-title,snmp-sysdescr,sip-methods,nbstat,smb-os-discovery,upnp-info,nbstat,http-server-header,rdp-vuln-ms12-020", host_ip
    ]
